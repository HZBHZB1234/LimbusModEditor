...
if (args.Length == 0 || args[0] is "help" or "--help" or "-h")
{
    ...
    Console.WriteLine("  spine-browse-ipc <keyword> <count> <out.json>");
    Console.WriteLine("                                           「Spine 总览」页的真实 IPC 证据：走 spine.catalog（只列名册）");
...
try
{
    switch (args[0].ToLowerInvariant())
    {
        ...
        case "wiki-export-ipc" when args.Length >= 4:
            ...
            break;
        case "spine-browse-ipc" when args.Length >= 4:
